  ...
  cursor: pointer;
	...
	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal form-material">
	    <div align="center" >
			...
			<div >
				<h4 >Description:</h4> 
				<textarea type="text" name="des" value="<?php echo $des;?>"></textarea>
				<span><?php echo $err_des;?></span>
			</div>
			<br>
			<div >
				<h4 >Image:</h4> 
				<input type="file" name="pimage" value="<?php echo $pimage;?>">
				<span><?php echo $err_pimage;?></span>
			</div>
			<br>
			<div >
				
				<input type="submit" name="add_book" class="red" value="Add Book" >
			</div>
		</form>
	</div>
